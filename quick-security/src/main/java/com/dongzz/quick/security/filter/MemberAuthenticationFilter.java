...
public class MemberAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public static final Logger logger = LoggerFactory.getLogger(MemberAuthenticationFilter.class);
    ...
    public MemberAuthenticationFilter() {
        super(new AntPathRequestMatcher("/auth/loginVip", "POST")); // 请求路径
    }
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        if (this.postOnly && !request.getMethod().equals("POST")) {
            ...
            // 封装认证信息
            MemberAuthenticationToken authRequest = new MemberAuthenticationToken(username, password);
